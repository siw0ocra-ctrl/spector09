...
if(id==='nova'){let rad=(90+L*15)*(A?1.6:1)*area;ring(r.x,r.y,rad,w.color,id);for(let e of targets())if(Math.hypot(e.x-r.x,e.y-r.y)<rad){hurt(e,d*1.5,id);if(A)e.slow=r.t+2}cd=3.6-L*.2}
